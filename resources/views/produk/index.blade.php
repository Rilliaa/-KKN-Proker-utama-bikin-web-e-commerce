...
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <button class="btn btn-primary mt-3 mb-3" data-toggle="modal" data-target="#addProductModal">Tambah Produk</button>
                        ...
                        @foreach ($produk as $p)
                            <tr>
                                ...
                                <td style="text-align: center">
                                    <img src="{{ asset('storage/'.$p->foto_utama) }}" alt="{{ $p->nama_produk }}" width="100">
                                </td>                     
                                <td style="text-align: center">
                                    ...
                                    <form action="{{ route('admin.produk-show',$p->id_produk)}}" method="GET" style="display:inline;">
                                        <button class="btn btn-info" >
                                            <i class="fa-solid fa-magnifying-glass"></i> Detail Barang
                                        </button>
                                    </form>
                                </td>
                            </tr>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="addProductForm">
                    ...
                    <div class="form-group">
                        <label for="harga">Link Produk:</label>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="editProductForm">
                    ...
                    <input type="hidden" id="edit_existing_foto" name="existing_foto"> <!-- untuk input tersembunyi, nanti di pake pada method update pada produkcontroller-->
                    <div class="form-group">
                        <label for="nama">Nama Produk:</label>
                    ...
                    <div class="form-group">
                        <label for="harga">Link Produk:</label>
                        <input type="text" class="form-control" id="edit_link_produk" name="edit_link_produk" required>
                    </div>
                    <div class="form-group">
                        <label for="harga">Foto Produk:</label>
